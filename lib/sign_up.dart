...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  bool _confirmPasswordVisible = false; // State to toggle confirm password visibility
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    cursorColor: Colors.blue, // Sets cursor color to blue
                    obscureText: !_confirmPasswordVisible, // Toggles confirm password visibility
                    decoration: InputDecoration(
                      prefixIcon: const Icon(Icons.lock_outline),
                      suffixIcon: IconButton(
                        icon: Icon(
                      ...
                      text: TextSpan(
                        ...
                        children: [
                          TextSpan(
                            ...
                            style: const TextStyle(
                              fontSize: 14,
                              color: Colors.orange, // Orange color for "Sign In"
                              fontWeight: FontWeight.bold,
                            ),
